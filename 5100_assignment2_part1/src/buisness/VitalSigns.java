...
public class VitalSigns {
    ...
    public String toString() {
        return "VitalSigns{" + "respiratoryRate=" + respiratoryRate + ", heartRate=" + heartRate + ", systolicBloodPressure=" + systolicBloodPressure + ", weightInKgs=" + weightInKgs + ", weightInPounds=" + weightInPounds + '}';
    }
